...
from .views import PostList, PostDetail, postSearch, Posts, PostCreateView, PostDetailView, PostUpdateView, PostDeleteView, PostCategoryView, subscribe_to_category
app_name = 'news'
urlpatterns = [
    # path -- означает путь. 
