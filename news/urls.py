...
from .views import PostList, PostDetail, postSearch, Posts, PostCreateView, PostDetailView, PostUpdateView, PostDeleteView, UserSubscribtion
app_name = 'news'
urlpatterns = [
    # path -- означает путь. 
    ...
    path('post/subscribe/', UserSubscribtion.as_view(), name='us_su')
]